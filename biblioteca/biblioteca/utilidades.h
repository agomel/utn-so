...
enum OPERACIONES{
	...
	DATOS_CONSEGUIDOS = 'j', DTB_LISTO = 'k' , RESPUESTA_CARGA = 'l', GUARDADO_CON_EXITO = 'm', ERROR = 'n',
	DESBLOQUEAR_DTB = 'o', BLOQUEAR_DTB = 'p', TRAER_LINEA_ESCRIPTORIO = 'q', GUARDAR_ESCRIPTORIO = 'r'
};
