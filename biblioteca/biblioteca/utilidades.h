...
enum OPERACIONES{
	...
	CREADO_CON_EXITO_EN_MDJ = '6', BORRADO_CON_EXITO_EN_MDJ = '7', CARGAR_DUMMY_EN_MEMORIA = '8', CARGADO_DUMMY_CON_EXITO_EN_MEMORIA = '9', GUARDAR_DATOS_DUMMY = '!'
};
...
enum ERROR{
	PATH_INEXISTENTE = 10001, ESPACIO_INSUFICIENTE_EN_MDJ = 10002, EL_ARCHIVO_NO_SE_ENCUENTRA_ABIERTO = 40001,
	FALLO_DE_SEGMENTO = 40002, ARCHIVO_YA_EXISTENTE = 50001, ESPACIO_INSUFICIENTE = 50002,
	EL_ARCHIVO_NO_EXISTE = 60001
};
