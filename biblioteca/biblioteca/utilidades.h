...
enum OPERACIONES{
	IDENTIFICARSE = 'a', PASAR_A_EXIT_POR_ERROR = 'b', MANDAR_MENSAJITO = 'c', CARGAR_ESCRIPTORIO_EN_MEMORIA = 'd',
	...
	CREADO_CON_EXITO_EN_MDJ = '6', BORRADO_CON_EXITO_EN_MDJ = '7', CARGAR_DUMMY_EN_MEMORIA = '8', LIBERAR_DTB_MEMORIA = '9', FINALIZARME = '%',
	CHAUCHI_CPU = '*'
};
